...
2. `dist/furniture-layout-2d-planner-docs.zip`、`docs/manual-test.md`、`docs/strict-manual-test-addendum.md` を取得する。
3. repo を clone する。

```powershell
git clone https://github.com/Sunmax0731/furniture-layout-2d-planner.git
cd furniture-layout-2d-planner
